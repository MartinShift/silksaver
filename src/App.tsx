...
import { incrementVisits, incrementEdits } from "./services/firebase";
...
export default function App() {
  ...
  const saveHistory = (item: HistoryItem) => {
    ...
    const trimmedHistory = updated.slice(0, 10);
  ...
  const decryptFile = () => {
    ...
    try {
      ...
      const gameType = detectGameType(pretty);
